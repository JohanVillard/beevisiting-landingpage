...
}, "/home/johan/Repository/holberton-beevisiting-landingpage/src/components/ui/forms/ContactForm.astro", void 0);
...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "seo": seo, "schema": schema }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto max-w-[85rem] px-4 pb-28 pt-48 sm:px-6 lg:px-8"> <div class="mb-10 max-w-3xl lg:mb-14"> <h2 class="text-balance text-4xl text-slate-800 sm:text-5xl md:text-6xl lg:text-7xl"> ${title} </h2> <p class="ml-1 mt-1 text-slate-600">${subTitle}</p> </div> <div class="grid grid-cols-1 gap-x-10 md:grid-cols-2 lg:gap-x-16"> <div class="mb-10 rounded-xl bg-yellow-400 pb-10 md:order-2 md:mb-0 md:pb-0"> ${renderComponent($$result2, "ContactForm", $$ContactForm, {})} </div>  ${renderScript($$result2, "/home/johan/Repository/holberton-beevisiting-landingpage/src/pages/contact.astro?astro&type=script&index=0&lang.ts")} </div></div>` })}`;
}, "/home/johan/Repository/holberton-beevisiting-landingpage/src/pages/contact.astro", void 0);

const $$file = "/home/johan/Repository/holberton-beevisiting-landingpage/src/pages/contact.astro";
const $$url = "/contact";
