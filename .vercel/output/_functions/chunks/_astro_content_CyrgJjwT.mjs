...
import { A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, a as createComponent, u as unescapeHTML, b as renderTemplate, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent } from './astro/server_uCupZySs.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BsTLX6nk.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B5Fmnvfy.mjs').then(n => n._);
